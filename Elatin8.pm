...
=item Make character
  ...
  set. For example, Elatin8::chr(65) is "A" in either ASCII or Latin-8, not Unicode,
  and Elatin8::chr(0x82a0) is a Latin-8 HIRAGANA LETTER A. For the reverse of
  Elatin8::chr, use Latin8::ord.
