...
=item Chop string
  ...
  character chopped. The Elatin8::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Elatin8::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Elatin8::fc function for case-insensitive comparisons via Latin8
  software.
...
=item Fold case string
  ...
  New to Latin8 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Elatin8::glob function grandfathers the use of whitespace to separate multiple
