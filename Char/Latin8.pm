...
# split
            ...
            my $e_string = 'Char::Elatin8::split';
...
and the cellular phone. This software treats Latin-8 directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Latin-8 values

=item * Backward compatibility of data, script and how to

=item * Only Char/Latin8.pm and Char/Elatin8.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Elatin8::lc
  lcfirst     Char::Elatin8::lcfirst
  uc          Char::Elatin8::uc
  ucfirst     Char::Elatin8::ucfirst
  chr         Char::Elatin8::chr
  glob        Char::Elatin8::glob
  ---------------------------------
...
Char/Latin8.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation On perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Elatin8.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Elatin8::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Elatin8::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  open(FH, "<:crlf:encoding(Char::Latin8)", $path) or die "can't open $path: $!";
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Latin-8
    +-----------------------------------+
                (No UTF8 Flag)
