...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin8::function_ord     = 'Char::Latin8::ord'     if /\A ord \z/oxms;
                    $Char::Elatin8::function_ord_    = 'Char::Latin8::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin8::function_reverse = 'Char::Latin8::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin8::function_getc    = 'Char::Latin8::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin8::escape();
...
=head1 Calling 'Char::Elatin8::ignorecase()' (Char::Latin8 software provides)

Char::Latin8 software applies calling 'Char::Elatin8::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin8 software provides)

Char::Latin8 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin8 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin8 software provides)

Char::Latin8 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin8 software and
