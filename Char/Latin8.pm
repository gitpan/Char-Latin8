...
######################################################################
#
# Char::Latin8 - Source code filter to Latin-8 script
#
...
sub Char::Latin8::escape_script {
    ...
    if (/^ use Char::Elatin8(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin8 %s;\n%s", $Char::Elatin8::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin8 - Source code filter to escape Latin-8

=head1 SYNOPSIS

  use Char::Latin8;
  use Char::Latin8 version;         --- require version
