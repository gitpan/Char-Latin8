...
#
package Char::Elatin8;
######################################################################
#
# Char::Elatin8 - Run-time routines for Char/Latin8.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Elatin8::index($name, '::') == -1) && (Char::Elatin8::index($name, "'") == -1)) {
            my $pkg;
...
#
# Latin-8 character range per length
#
my %range_tr = ();
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Elatin8::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Elatin8::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Elatin8::split(;$$$);
sub Char::Elatin8::tr($$$$;$);
sub Char::Elatin8::chop(@);
sub Char::Elatin8::index($$;$);
sub Char::Elatin8::rindex($$;$);
sub Char::Elatin8::lcfirst(@);
sub Char::Elatin8::lcfirst_();
sub Char::Elatin8::lc(@);
sub Char::Elatin8::lc_();
sub Char::Elatin8::ucfirst(@);
sub Char::Elatin8::ucfirst_();
sub Char::Elatin8::uc(@);
sub Char::Elatin8::uc_();
sub Char::Elatin8::fc(@);
sub Char::Elatin8::fc_();
sub Char::Elatin8::ignorecase;
sub Char::Elatin8::classic_character_class;
sub Char::Elatin8::capture;
sub Char::Elatin8::chr(;$);
sub Char::Elatin8::chr_();
sub Char::Elatin8::glob($);
sub Char::Elatin8::glob_();

sub Char::Latin8::ord(;$);
sub Char::Latin8::ord_();
sub Char::Latin8::reverse(@);
sub Char::Latin8::getc(;*@);
sub Char::Latin8::length(;$);
sub Char::Latin8::substr($$;$$);
sub Char::Latin8::index($$;$);
sub Char::Latin8::rindex($$;$);
sub Char::Latin8::escape(;$);
...
${Char::Elatin8::dot}         = qr{(?:[^\x0A])};
${Char::Elatin8::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Elatin8::eD}          = qr{(?:[^0-9])};
...
# ${Char::Elatin8::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Elatin8::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Elatin8::eS}          = qr{(?:[^\s])};

${Char::Elatin8::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Elatin8::eH}          = qr{(?:[^\x09\x20])};
${Char::Elatin8::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Elatin8::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Elatin8::eN}          = qr{(?:[^\x0A])};
${Char::Elatin8::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Elatin8::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Elatin8::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Elatin8::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Elatin8::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Elatin8::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Elatin8::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Elatin8::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Elatin8::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin8::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Elatin8::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Elatin8::not_space}   = qr{(?:[^\s\x0B])};
${Char::Elatin8::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Elatin8::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin8::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Elatin8::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Elatin8::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Elatin8::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Elatin8::foo" used only once: possible typo at here.
${Char::Elatin8::dot}         = ${Char::Elatin8::dot};
${Char::Elatin8::dot_s}       = ${Char::Elatin8::dot_s};
${Char::Elatin8::eD}          = ${Char::Elatin8::eD};
${Char::Elatin8::eS}          = ${Char::Elatin8::eS};
${Char::Elatin8::eW}          = ${Char::Elatin8::eW};
${Char::Elatin8::eH}          = ${Char::Elatin8::eH};
${Char::Elatin8::eV}          = ${Char::Elatin8::eV};
${Char::Elatin8::eR}          = ${Char::Elatin8::eR};
${Char::Elatin8::eN}          = ${Char::Elatin8::eN};
${Char::Elatin8::not_alnum}   = ${Char::Elatin8::not_alnum};
${Char::Elatin8::not_alpha}   = ${Char::Elatin8::not_alpha};
${Char::Elatin8::not_ascii}   = ${Char::Elatin8::not_ascii};
${Char::Elatin8::not_blank}   = ${Char::Elatin8::not_blank};
${Char::Elatin8::not_cntrl}   = ${Char::Elatin8::not_cntrl};
${Char::Elatin8::not_digit}   = ${Char::Elatin8::not_digit};
${Char::Elatin8::not_graph}   = ${Char::Elatin8::not_graph};
${Char::Elatin8::not_lower}   = ${Char::Elatin8::not_lower};
${Char::Elatin8::not_lower_i} = ${Char::Elatin8::not_lower_i};
${Char::Elatin8::not_print}   = ${Char::Elatin8::not_print};
${Char::Elatin8::not_punct}   = ${Char::Elatin8::not_punct};
${Char::Elatin8::not_space}   = ${Char::Elatin8::not_space};
${Char::Elatin8::not_upper}   = ${Char::Elatin8::not_upper};
${Char::Elatin8::not_upper_i} = ${Char::Elatin8::not_upper_i};
${Char::Elatin8::not_word}    = ${Char::Elatin8::not_word};
${Char::Elatin8::not_xdigit}  = ${Char::Elatin8::not_xdigit};
${Char::Elatin8::eb}          = ${Char::Elatin8::eb};
${Char::Elatin8::eB}          = ${Char::Elatin8::eB};
...
#
# Latin-8 lower case first with parameter
#
sub Char::Elatin8::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin8::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-8 lower case first without parameter
#
sub Char::Elatin8::lcfirst_() {
    return Char::Elatin8::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-8 lower case with parameter
#
sub Char::Elatin8::lc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Elatin8::lc_();
    }
}

#
# Latin-8 lower case without parameter
#
sub Char::Elatin8::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-8 upper case first with parameter
#
sub Char::Elatin8::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin8::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Latin-8 upper case first without parameter
#
sub Char::Elatin8::ucfirst_() {
    return Char::Elatin8::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Latin-8 upper case with parameter
#
sub Char::Elatin8::uc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Elatin8::uc_();
    }
}

#
# Latin-8 upper case without parameter
#
sub Char::Elatin8::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Latin-8 fold case with parameter
#
sub Char::Elatin8::fc(@) {
    if (@_) {
        my $s = shift @_;
...
#
# Latin-8 regexp ignore case modifier
#
sub Char::Elatin8::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Elatin8::uc($char[$i]);
                my $fc = Char::Elatin8::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Latin-8 characters per length
#
...
#
# Latin-8 open character list for tr
#
sub _charlist_tr {
...
#
# Latin-8 open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Elatin8::not_lower_i}',
                '[:^upper:]'  => '${Char::Elatin8::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Elatin8::not_alnum}',
                '[:^alpha:]'  => '${Char::Elatin8::not_alpha}',
                '[:^ascii:]'  => '${Char::Elatin8::not_ascii}',
                '[:^blank:]'  => '${Char::Elatin8::not_blank}',
                '[:^cntrl:]'  => '${Char::Elatin8::not_cntrl}',
                '[:^digit:]'  => '${Char::Elatin8::not_digit}',
                '[:^graph:]'  => '${Char::Elatin8::not_graph}',
                '[:^lower:]'  => '${Char::Elatin8::not_lower}',
                '[:^print:]'  => '${Char::Elatin8::not_print}',
                '[:^punct:]'  => '${Char::Elatin8::not_punct}',
                '[:^space:]'  => '${Char::Elatin8::not_space}',
                '[:^upper:]'  => '${Char::Elatin8::not_upper}',
                '[:^word:]'   => '${Char::Elatin8::not_word}',
                '[:^xdigit:]' => '${Char::Elatin8::not_xdigit}',
...
#
# Latin-8 hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Latin-8 open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Elatin8::uc($char);
                        my $fc = Char::Elatin8::fc($char);
                        if ($uc eq $fc) {
...
#
# Latin-8 open character list for not qr
#
sub charlist_not_qr {
...
#
# Latin-8 order to character (with parameter)
#
sub Char::Elatin8::chr(;$) {
...
#
# Latin-8 order to character (without parameter)
#
sub Char::Elatin8::chr_() {
...
#
# Latin-8 path globbing (with parameter)
#
sub Char::Elatin8::glob($) {
...
#
# Latin-8 path globbing (without parameter)
#
sub Char::Elatin8::glob_() {
...
#
# Latin-8 path globbing via File::DosGlob 1.10
#
...
#
# Latin-8 path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Elatin8::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Elatin8::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Elatin8::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Elatin8::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Char::Elatin8::POSTMATCH {
    return $';
}

#
# Latin-8 character to order (with parameter)
#
sub Char::Latin8::ord(;$) {
...
#
# Latin-8 character to order (without parameter)
#
sub Char::Latin8::ord_() {
...
#
# Latin-8 getc (with parameter, without parameter)
#
sub Char::Latin8::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Char::Latin8::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Elatin8::dot_s} \z/oxms) {
...
#
# Latin-8 index by character
#
sub Char::Latin8::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Char::Elatin8::index($_[0], $_[1], CORE::length(Char::Latin8::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Elatin8::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Latin8::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Latin-8 rindex by character
#
sub Char::Latin8::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Elatin8::rindex($_[0], $_[1], CORE::length(Char::Latin8::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Elatin8::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Latin8::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Latin8::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Latin8::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Latin8::escape_token();
    }
...
#
# escape Latin-8 token of script
#
sub Char::Latin8::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin8::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin8::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin8::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin8::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin8::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin8::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Elatin8::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Elatin8::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Elatin8::glob';
    }
...
# subroutines of package Char::Elatin8
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Latin8::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Latin8::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Latin8::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin8::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Latin8::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin8::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin8::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Latin8::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin8::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin8::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin8::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin8::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin8::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Elatin8::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Elatin8::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Elatin8::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Elatin8::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Elatin8::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Elatin8::PREMATCH()]}
            ...
            $e_string .= q{Char::Elatin8::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Elatin8::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Elatin8::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Elatin8::POSTMATCH()]}
            ...
            $e_string .= q{Char::Elatin8::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Elatin8
        ...
        elsif ($string =~ /\G \b Char::Latin8::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin8::eval \b                                /oxgc) { $e_string .= 'eval Char::Latin8::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Elatin8::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin8::index \b                               /oxgc) { $e_string .= 'Char::Latin8::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Elatin8::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin8::rindex \b                              /oxgc) { $e_string .= 'Char::Latin8::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Elatin8::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin8::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Elatin8::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin8::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Elatin8::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin8::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Elatin8::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Elatin8::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Elatin8::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin8::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Elatin8::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Elatin8::dot_s}';
        }
        else {
            return '${Char::Elatin8::dot}';
        }
    }
    else {
        return Char::Elatin8::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Elatin8::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Elatin8::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Elatin8::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Elatin8::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Elatin8::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Elatin8::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Elatin8::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Elatin8::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Elatin8::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin8::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin8::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin8::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin8::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Elatin8::uc($char[$i]) ne Char::Elatin8::fc($char[$i]))) {
            if (CORE::length(Char::Elatin8::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Elatin8::uc($char[$i])       . Char::Elatin8::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Elatin8::uc($char[$i]) . '|' . Char::Elatin8::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin8::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin8::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin8::ignorecase(Char::Elatin8::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin8::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin8::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin8::ignorecase(Char::Elatin8::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin8::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin8::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin8::ignorecase(Char::Elatin8::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin8::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Latin8::re_t=%s; while($Char::Latin8::re_t =~ %s){%s local $^W=0; local $Char::Latin8::re_r=%s; %s$Char::Latin8::re_t="$`$Char::Latin8::re_r$'"; pos($Char::Latin8::re_t)=length "$`$Char::Latin8::re_r"; } return $Char::Latin8::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Latin8::re_r=CORE::eval $Char::Latin8::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Latin8::re_r=%s; %s"%s$Char::Latin8::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Latin8::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Latin8::re_r=%s; %s%s="$`$Char::Latin8::re_r$'"; pos(%s)=length "$`$Char::Latin8::re_r"; $Char::Latin8::re_n++} return %s$Char::Latin8::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Latin8::re_r=%s; %s%s="%s$Char::Latin8::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Latin8::re_r=%s; %s%s="%s$Char::Latin8::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Latin8::re_r=CORE::eval $Char::Latin8::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin8::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Elatin8::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Elatin8::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Elatin8;
    ...
    Char::Elatin8::lc(...);
    Char::Elatin8::lc_;
    Char::Elatin8::lcfirst(...);
    Char::Elatin8::lcfirst_;
    Char::Elatin8::uc(...);
    Char::Elatin8::uc_;
    Char::Elatin8::ucfirst(...);
    Char::Elatin8::ucfirst_;
    Char::Elatin8::fc(...);
    Char::Elatin8::fc_;
    Char::Elatin8::ignorecase(...);
    Char::Elatin8::capture(...);
    Char::Elatin8::chr(...);
    Char::Elatin8::chr_;
    Char::Elatin8::glob(...);
    Char::Elatin8::glob_;

  # "no Char::Elatin8;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Latin8 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin8 software and not
...
This Char::Elatin8 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Elatin8::split(/pattern/,$string,$limit);
  @split = Char::Elatin8::split(/pattern/,$string);
  @split = Char::Elatin8::split(/pattern/);
  @split = Char::Elatin8::split('',$string,$limit);
  @split = Char::Elatin8::split('',$string);
  @split = Char::Elatin8::split('');
  @split = Char::Elatin8::split();
  @split = Char::Elatin8::split;
  ...
  at all, Char::Elatin8::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Elatin8::split(//,  $word);
  @fields = Char::Elatin8::split(/:/, $line);
  @words  = Char::Elatin8::split(" ", $paragraph);
  @lines  = Char::Elatin8::split(/^/, $buffer);
  ...
  print join(":" => Char::Elatin8::split(/ */, "hi there"));
  ...
  Char::Elatin8::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Elatin8::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Elatin8::split with no arguments does. Thus,
  Char::Elatin8::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Elatin8::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Elatin8::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Elatin8::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Elatin8::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Elatin8::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Elatin8::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Elatin8::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Latin-8 string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Latin-8 string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Char::Elatin8::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Elatin8::chop(@list);
  $chop = Char::Elatin8::chop();
  $chop = Char::Elatin8::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Elatin8::chop subroutine is used primary to remove the newline
  ...
  since Char::Elatin8::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Elatin8::chop a literal, only a variable. If you Char::Elatin8::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Elatin8::chop(@lines);

  You can Char::Elatin8::chop anything that is an lvalue, including an assignment:

  Char::Elatin8::chop($cwd = `pwd`);
  Char::Elatin8::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Elatin8::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Elatin8::chop returns the character
  ...
  In the most general case, Char::Elatin8::chop can be expressed using substr:

  $last_code = Char::Elatin8::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Elatin8::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Elatin8::chop;
...
=item Index string
  ...
  $byte_pos = Char::Elatin8::index($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin8::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Elatin8::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Elatin8::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin8::rindex($string,$substr);

  This subroutine works just like Char::Elatin8::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Elatin8::index).
  ...
  while (($byte_pos = Char::Latin8::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Elatin8::lc($string);
  $lc = Char::Elatin8::lc_;

  This subroutine returns a lowercased version of Latin-8 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Char::Elatin8::fc subroutine for case-insensitive comparisons via Char::Latin8
  software.

=item Lower case first character of string

  $lcfirst = Char::Elatin8::lcfirst($string);
  $lcfirst = Char::Elatin8::lcfirst_;

  This subroutine returns a version of Latin-8 $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Char::Elatin8::uc($string);
  $uc = Char::Elatin8::uc_;

  This subroutine returns an uppercased version of Latin-8 $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Char::Elatin8::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Elatin8::ucfirst($string);
  $ucfirst = Char::Elatin8::ucfirst_;
  ...
  $titlecase = Char::Elatin8::ucfirst(substr($word,0,1)) . Char::Elatin8::lc(substr($word,1));
  ...
  $do_not_use = Char::Elatin8::ucfirst(Char::Elatin8::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Elatin8::fc($string);
  $fc = Char::Elatin8::fc_;

  New to Char::Latin8 software, this subroutine returns the full Unicode-like casefold of
  Latin-8 $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Char::Elatin8::fc($a) eq Char::Elatin8::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Latin8 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Elatin8::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Elatin8::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Elatin8::chr($code);
  $chr = Char::Elatin8::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Elatin8::chr(65) is "A" in either
  ASCII or Latin-8, not Unicode. For the reverse of Char::Elatin8::chr, use Char::Latin8::ord.

=item Filename expansion (globbing)

  @glob = Char::Elatin8::glob($string);
  @glob = Char::Elatin8::glob_;
  ...
  The Char::Elatin8::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Elatin8::glob('"*e f*"');
  @spacies = Char::Elatin8::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Elatin8::glob("'*${var}e f*'");
  @spacies = Char::Elatin8::glob(qq("*${var}e f*"));
