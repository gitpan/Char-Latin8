...
This module is a run-time routines of the Char/Latin8.pm.
Because the Char/Latin8.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a Latin-8 string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Elatin8::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Elatin8::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Latin-8 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Elatin8::fc function for case-insensitive comparisons via Char::Latin8
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Latin-8 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Latin-8 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Latin8 software, this function returns the full Unicode-like casefold of
  Latin-8 $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Elatin8::glob function grandfathers the use of whitespace to separate multiple
