...
######################################################################
#
# Latin8 - Source code filter to Latin-8 script
#
...
sub Latin8::escape_script {
    ...
    if (/^ use Elatin8(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Elatin8 %s;\n%s", $Elatin8::VERSION, $use_re_eval); # require run-time routines version

        # use Latin8 version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
Latin8 - Source code filter to escape Latin-8

=head1 SYNOPSIS

  use Latin8;
  use Latin8 version;         --- require version
...
Contrasting is Encode module and describing "use Latin8;" on this software,
