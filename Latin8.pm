...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin8::uc($char[$i]) ne Elatin8::lc($char[$i]))) {
...
=item * Only Latin8.pm and Elatin8.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin8::lc
  lcfirst     Elatin8::lcfirst
  uc          Elatin8::uc
  ucfirst     Elatin8::ucfirst
  chr         Elatin8::chr
  glob        Elatin8::glob
  ---------------------------------
...
Latin8.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin8.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin8::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin8::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin8 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  open(FH, "<:crlf:encoding(Latin8)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin8.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin8.pm provides bytes::*
