...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin8 software provides)

Latin8 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin8 software provide)
